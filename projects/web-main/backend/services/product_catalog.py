ANALYSIS_TEMPLATES = [
    ...
    },
    {
        ...
        "name": "Band Power",
        "module": "band_power",
        "engine": "MNE Raw.compute_psd(method='welch') + validated frequency-band summaries",
        "outputs": ["tables/band_power.csv", "tables/channel_band_power.csv", "figures/band_power.svg", "reproducibility/band_power_summary.json", "reproducibility/parameters.json"],
        "production_status": "v01_enabled",
        "enabled": True,
        "prerequisites": ["Readable EEG file", "At least one usable EEG channel", "QC reviewed before interpretation"],
    },
...
PARADIGMS = [
    {
        ...
        "recommended_templates": ["metadata_qc", "resting_psd", "band_power"],
        "notes": "Start with QC, then inspect PSD spectra and descriptive band-power summaries separately. Interpret power metrics with reference, artifacts, and individual alpha peak variability.",
    },
    {
        "id": "oddball_p300",
...
RECOMMENDATION_RULES = [
    ...
    },
    {
        ...
        "reason": "Continuous resting or eyes-open/eyes-closed data should start with PSD spectrum review after QC.",
        "parameters": {"fmin": 1, "fmax": 40},
    },
    {
        "key": "continuous_rest_band_power",
        "template_id": "band_power",
        "reason": "Use Band Power when the requested deliverable is predefined frequency-band summaries rather than the full PSD spectrum.",
        "parameters": {"fmin": 1, "fmax": 40},
    },
]
