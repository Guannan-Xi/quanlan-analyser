...
def run_pac(input_path: str | Path, output_dir: str | Path, parameters: dict | None = None) -> dict[str, Path]:
    ...
    sidecars = write_analysis_sidecars(
        ...
        scope_contract={
            "analysis_scope": "single_record_descriptive_sensor_space_pac_beta",
            "stable_status": "beta_lab_only",
            "allowed_claims": [
                "Describe phase-amplitude coupling metrics for one uploaded recording in sensor/channel space.",
                "Summarize exploratory PAC patterns for research review with artifact and parameter context.",
            ],
            "disallowed_claims": [
            ...
            "customer_boundary_note": PAC_BOUNDARY,
        },
