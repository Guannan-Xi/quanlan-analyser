        ...
        rows.append(
            {
                ...
                "screening_label": "epilepsy_like_candidate" if int(stage_code) == 1 else "not_candidate",
                "Candidate_Label": "epilepsy_like_candidate" if int(stage_code) == 1 else "not_candidate",
                "Stage": "epilepsy_like_candidate" if int(stage_code) == 1 else "not_candidate",
