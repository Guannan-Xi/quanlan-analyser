...
METHODS = [
    ...
    },
    {
        "ui_id": "band_power",
        "label": "Band Power",
        "task_module_name": "band_power",
        "workflow_id": "band_power",
        "runner_backend_module": "band_power",
        "acceptance_scope": "targeted_ui_validation",
        "independent_contract": {
            "must_submit_module_name": "band_power",
            "must_submit_workflow_id": "band_power",
            "expected_outputs": [
...
def build_manifest(evidence: dict[str, dict[str, Any]], docs: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "accepted_current_slice": [
            "Band Power is accepted as an independent method and must submit module_name=band_power, workflow_id=band_power.",
