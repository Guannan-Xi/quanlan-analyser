...
def main() -> int:
    ...
    if table_dictionary.get("module") != "tfr_ersp_itc":
        failures.append(f"table_dictionary_module_mismatch:{table_dictionary.get('module')}")
    if not isinstance(table_dictionary.get("tables"), dict) or "tables/tfr_power_long.csv" not in table_dictionary.get("tables", {}):
        failures.append("table_dictionary_missing_tfr_table")
