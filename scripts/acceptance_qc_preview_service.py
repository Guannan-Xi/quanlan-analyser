...
def build_sample() -> Path:
    ...
    sample = work / "qc_preview_raw.fif"
    sfreq = 200.0
    ch_names = ["Fz", "Cz", "Pz", "Oz", "Fp1", "Fp2", "C3", "C4"]
...
def main() -> None:
    ...
    print(json.dumps({"status": "passed", "task_id": task["id"], "artifacts": len(artifacts)}, ensure_ascii=False, indent=2))
